...
> 在 StackOverflow 和类似论坛上有关性能的帖子中，您经常会听到 Knuth 关于优化的引用的一些变体：“过早的优化是万恶之源。” 这种简化忽略了 [原始报价](https://raw.githubusercontent.com/tingSenses/go-collection/main/go-translation/file/knuth-GOTO.pdf) 中存在的一些重要上下文：
>
